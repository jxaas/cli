...
class CliApp(App):
    ...
    def __init__(self):
      ...
      command_manager.add_command('wait-instance', instances.WaitInstance)
      ...
      command_manager.add_command('get-options', instanceconfig.GetOptions)
      command_manager.add_command('set-option', instanceconfig.SetOption)
